...
- writeback_id: `writeback-integrated-exec-enterprise`
- intake_id: `intake-integrated-exec-enterprise`
- collaboration_mode: `integrated`
- used_default_rules: `false`
- focus_priority: []
- special_attention: []
- target_audience: `exec`
- extra_questions: [`multi_human_multiagent_enterprise_management`]
...
给高层看的 integrated 版：多人多agent管理如何改变企业控制边界
